...
## Key points^[This document is available under a CC 0 license. If you find typo's or want to make other suggestions, please do so via Github (click [here](https://github.com/chartgerink/talks/edit/master/2016_2017/20170808utrecht/collaborate_handout.Rmd))]
...
knitr::include_graphics('figures/hero.png')
```
