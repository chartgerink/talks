...
```{r, echo=FALSE}
knitr::include_graphics('http://wac-cdn.atlassian.com/dam/jcr:389059a7-214c-46a3-bc52-7781b4730301/hero.svg?cdnVersion=fp')
```

## Version control

```{r, echo=FALSE}
knitr::include_graphics('http://media.springernature.com/full/springer-static/image/art%3A10.1186%2F1751-0473-8-7/MediaObjects/13029_2013_Article_88_Fig3_HTML.jpg')
```
